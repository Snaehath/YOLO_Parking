...
def detect():
    ...
    # inverted_result = ocr.ocr(inverted_img, cls=True)
    # inverted_text_output = ""
    # for line in inverted_result:
    #     for word in line:
    #         inverted_text_output += word[1][0]

    # # Determine which result has a longer string
    # if len(inverted_text_output) > len(text_output):
    #     text_output = inverted_text_output
